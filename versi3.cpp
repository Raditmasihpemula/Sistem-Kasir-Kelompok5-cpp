#define _CRT_SECURE_NO_WARNINGS // WAJIB ADA DI BARIS 1: Agar Windows tidak error saat pakai fungsi waktu standar
#include <iostream>
#include <vector>
#include <string>
#include <iomanip>
...
string generateTransactionID() {
    time_t now = time(0);
    // Menggunakan localtime standar (Aman di Linux, Warning di Windows tapi sudah di-suppress)
...
void updateProdukTerlaris() {
    ...
    // Sorting Descending (Terbanyak ke terkecil)
